...
`vibecoding-bootstrap/scripts/apply-template.sh` when a new project is bootstrapped from this
template.
...
This template is managed by [vibecoding-copilot-governance](https://github.com/lowcodai/vibecoding-copilot-governance).
...
- [vibecoding-bootstrap](https://github.com/lowcodai/vibecoding-bootstrap)
